...
if (!function_exists('get_reports_topbar')) {
    ...
    function get_reports_topbar($return_array = false) {
        ...
        if (($project_timesheet || $ticket_timesheet || $general_task_timesheet) && ($ci->login_user->is_admin || !get_array_value($permissions, "do_not_show_projects"))) {
            $reports_menu[] = array("name" => "timesheets", "url" => "timesheets", "class" => "clock", "single_button" => true);
        }
