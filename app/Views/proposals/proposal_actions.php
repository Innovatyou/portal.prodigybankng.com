    ...
    <div class="card-body">
        ...
        <div class="box b-t">
            <div class="box-content pt15 b-r">
                <?php echo anchor(get_uri("proposals/download_pdf/" . $proposal_info->id . "/view"), "<i data-feather='file-text' class='icon-16'></i> " . app_lang('view_pdf'), array("title" => app_lang('view_pdf'), "target" => "_blank", "class" => "d-none d-md-inline-block")); ?>
                <span class="d-block d-md-none"><?php echo js_anchor("<i data-feather='file-text' class='icon-16'></i> " . app_lang('view_pdf'), array('title' => app_lang('view_pdf'), "data-group" => "invoice-pdf", "data-toggle" => "app-modal", "data-sidebar" => "0", "data-url" => get_uri("proposals/view_pdf/" . $proposal_info->id), "class" => "mobile-pdf-view-btn")) ?></span>
            </div>
