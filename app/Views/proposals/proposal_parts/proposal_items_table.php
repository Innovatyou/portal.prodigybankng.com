...
$item_column_width = get_setting("show_item_image_in_proposal_item_list") ? "35%" : "50%";
$colspan = get_setting("show_item_image_in_proposal_item_list") ? 4 : 3;
...
<table class="table-responsive" style="width: 100%;">
    <tr style="font-weight: bold; background-color: <?php echo $color; ?>; color: #fff;  ">
        <?php if(get_setting("show_item_image_in_proposal_item_list")) { ?>
    ...
    ?>
        <tr style="background-color: #f4f4f4; ">
            ...
            <?php } ?>
            <td style="width: <?php echo $item_column_width; ?>; border: 1px solid #fff; padding: 10px; hyphens: auto;"><p class="mb5"><?php echo $item->title; ?></p>
    ...
    <?php if ($proposal_total_summary->tax) { ?>
        <tr>
            <td colspan="<?php echo $colspan; ?>" style="text-align: right;"><?php echo $proposal_total_summary->tax_name; ?></td>
            <td style="text-align: right; width: 20%; border: 1px solid #fff; background-color: #f4f4f4;">
    ...
    <?php if ($proposal_total_summary->tax2) { ?>
        <tr>
            <td colspan="<?php echo $colspan; ?>" style="text-align: right;"><?php echo $proposal_total_summary->tax_name2; ?></td>
            <td style="text-align: right; width: 20%; border: 1px solid #fff; background-color: #f4f4f4;">
