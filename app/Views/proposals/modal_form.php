...
<div class="modal-body clearfix">
    <div class="container-fluid">
        ...
        <?php if ($model_info->id && $login_user->is_admin && !$is_clone) { ?>
            <div class="form-group">
                <div class="row">
                    <label for="display_id" class=" col-md-3"><?php echo app_lang('proposal_id'); ?></label>
                    <div class="col-md-9">
                        <?php
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <?php
                        echo form_input(array(
                            "id" => "proposal_client_id",
                            "name" => "proposal_client_id",
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#proposal_client_id").appDropdown({
