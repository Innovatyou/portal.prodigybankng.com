<div class="card bg-white mb15 workflow-signin-card">
    <div class="card-header text-center">
        ...
        <?php } ?>
        <h2 class="workflow-form-title">Welcome to WorkFlow</h2>
        <p class="workflow-form-subtitle">Sign in to manage operations and approvals.</p>
    </div>
