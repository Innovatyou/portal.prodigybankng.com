<div>
    <div class="card-header clearfix border-bottom-0">
        <div class="float-start clearfix timesheet-buttons">
            <span id="monthly-chart-date-range-selector" class="float-start full-width-date-range-selector"></span>
            <?php
            if (!$user_id) {
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        //initialize data
        $("#members-dropdown").select2({
            data: <?php echo $members_dropdown; ?>
        });
        $("#projects-dropdown").select2({
        ...
        prepareTimesheetStatisticsChart = function() {
            ...
            var user_id = $("#members-dropdown").val() || "0",
                project_id = $("#projects-dropdown").val() || "0";

            appAjaxRequest({
                url: "<?php echo_uri("timesheets/chart_data/" . $project_id . "/" . $user_id) ?>",
                data: {
