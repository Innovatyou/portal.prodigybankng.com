    ...
    <div class="container-fluid">
        ...
        <?php if ($has_pdf_access) { ?>
            <div class="form-group ml15">
                ...
                ?>
                <label for="attach_pdf"><?php echo app_lang('attach_pdf') . ' ' . anchor(get_uri("contracts/download_pdf/" . $contract_info->id . "/download"), get_hyphenated_string($contract_info->display_id) . ".pdf", array("target" => "_blank", "id" => "attachment-url")); ?></label>
            </div>
        <?php } ?>
