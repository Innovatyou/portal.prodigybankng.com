                ...
                if ($contract_info->files) {
                    ...
                    if (count($files)) {
                        foreach ($files as $key => $value) {
                            ...
                            echo js_anchor($file_icon, array('title' => "", "data-toggle" => "app-modal", "data-sidebar" => "0", "class" => "float-start ml5 mr10 mt-4", "title" => remove_file_prefix($file_name), "data-url" => get_uri("contract/file_preview/" . $contract_info->id . "/" . $key . "/" . $contract_info->public_key)));
                        }
                    }
                }
            }
