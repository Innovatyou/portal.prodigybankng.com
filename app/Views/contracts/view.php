...
<div class="details-view-top-button clearfix">
    <?php
    echo view("includes/back_button", array("button_url" => get_uri("contracts/index"), "button_text" => app_lang("contracts"), "extra_class" => "float-start dark"));
    ?>
</div>

<div class="page-content contract-details-view xs-full-width clearfix">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var imageColumnVisibility = "<?php echo get_setting("show_item_image_in_contract_item_list") ? true : false; ?>";
        ...
        $("#contract-item-table").appTable({
            ...
            columns: [{
                ...
                {
                    title: "<?php echo app_lang("image") ?> ",
                    sortable: false,
                    visible: imageColumnVisibility
                },
                {
