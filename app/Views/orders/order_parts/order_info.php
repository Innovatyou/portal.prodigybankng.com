...
<span class="invoice-meta text-default"><?php echo app_lang("order_number") . ": " . $order_info->display_id; ?></span><br />
<?php } else { ?>
<span style="font-size:20px; font-weight: bold;background-color: <?php echo $color; ?>; color: #fff;">&nbsp;<?php echo $order_info->display_id; ?>&nbsp;</span>
