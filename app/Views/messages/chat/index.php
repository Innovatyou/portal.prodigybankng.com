...
?>
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            //close chat box
            $(document).on('click', '#js-rise-chat-wrapper #chat-close-icon', function() {
                setChatIcon("open");
                setCookie("chatbox_open", "");
                setCookie("active_chat_id", "");
                feather.replace();
            ...
            $(document).on('click', '#js-rise-chat-wrapper .reset-chat-dimension', function() {
                ...
                $('#js-rise-chat-wrapper .chat-full-screen').removeClass('hide');
                $('#js-rise-chat-wrapper .chat-exit-full-screen').addClass('hide');

                adjustChatBodyHeight();
            });

            //chat full screen
            $(document).on('click', '#js-rise-chat-wrapper .chat-full-screen', function() {
                enterChatFullScreen();
            });

            //chat exit full screen
            $(document).on('click', '#js-rise-chat-wrapper .chat-exit-full-screen', function() {
                exitChatFullScreen();
            });

            $(document).on('click', '#js-rise-chat-wrapper .chat-back', function() {
        ...
        function adjustChatBodyHeight() {
            var $wrapper = $('#js-rise-chat-wrapper');
            var chatBoxHeight = $wrapper.height();
            var headerHeight = $wrapper.find('.rise-chat-header, .chat-topbar').outerHeight() || 60;
            var footerHeight = $wrapper.find('.rise-chat-footer').outerHeight() || 77;

            $wrapper.find('.rise-chat-body').height(chatBoxHeight - (headerHeight + footerHeight));
        }
