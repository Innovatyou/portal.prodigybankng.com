...
<script type="text/javascript">
    $(document).ready(function() {
        function updateChatTitle() {
            var activeTabText = $("#js-rise-chat-wrapper .chat-tab .active .chat-tab-text").text();
            if (!activeTabText) {
                activeTabText = $("#js-rise-chat-wrapper .chat-tab a:first .chat-tab-text").text();
            }
            $("#js-rise-chat-wrapper .chat-topbar-title").text(activeTabText);
        }

        updateChatTitle();

        $("#js-rise-chat-wrapper .chat-tab a").on("click", function() {
            updateChatTitle();
        });

        //drag and drop
        makeDraggable("#js-rise-chat-wrapper .chat-topbar", "#js-rise-chat-wrapper", async function(pos) {
