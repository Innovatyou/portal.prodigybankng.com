...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var chatBoxHeight = $chatWrapper.height();
        $chatWrapper.find(".rise-chat-body").height(chatBoxHeight - 152);

        var textarea = document.querySelector('#js-rise-chat-wrapper .rise-chat-footer textarea');
        ...
        function autosizeRISEChatBox() {
            ...
            setTimeout(function() {
                if (el.scrollHeight < 110) {
                    var chatWrapperHeight = $("#js-rise-chat-wrapper").height();
                    $("#js-rise-chat-wrapper").find(".rise-chat-body").height(chatWrapperHeight - el.scrollHeight - 103);
        ...
        //drag and drop
        makeDraggable("#js-rise-chat-wrapper .rise-chat-header", "#js-rise-chat-wrapper", async function(pos) {
        ...
        $("#chat-message-reply-form").appForm({
            ...
            onSuccess: function(response) {
                ...
                if (response.success) {
                    ...
                    $("#chat-message-reply-form #fast-loader").remove();
                }
        ...
        $("#js-rise-chat-wrapper .message-send-button").click(function() {
            $("#chat-message-reply-form").submit();
        });
