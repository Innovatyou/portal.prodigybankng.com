<div class="card" id="invoice-details-invoice-info">
    ...
    <div class="card-body">
        <ul class="list-group info-list">
            ...
            <?php } ?>
            <?php if ($invoice_info->sales_executive_id) { ?>
                <li class="list-group-item">
                    <span title="<?php echo app_lang("sales_executive"); ?>"><i data-feather="user" class="icon-16 mr5"></i> <?php echo (anchor(get_uri("team_members/view/" . $invoice_info->sales_executive_id), $invoice_info->sales_executive_name)); ?></span>
                </li>
            <?php } ?>
            ...
            <?php if ($invoice_info->subscription_id) { ?>
                <li class="list-group-item">
                    <span title="<?php echo app_lang("created_from"); ?>"><i data-feather="corner-down-right" class="icon-16 mr5"></i> <?php echo anchor(get_uri("subscriptions/view/" . $invoice_info->subscription_id), $invoice_info->subscription_display_id); ?></span>
                </li>
            <?php } ?>
            <?php if ($invoice_info->estimate_id && $login_user->is_admin) { ?>
                <li class="list-group-item">
                    <span title="<?php echo app_lang("created_from"); ?>"><i data-feather="corner-down-right" class="icon-16 mr5"></i> <?php echo anchor(get_uri("estimates/view/" . $invoice_info->estimate_id), $invoice_info->estimate_display_id); ?></span>
                </li>
            <?php } ?>
