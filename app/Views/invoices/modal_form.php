...
<div id="invoices-dropzone" class="post-dropzone">
    <div class="modal-body clearfix">
        <div class="container-fluid">
            ...
            <div class="form-group">
                <div class="row">
                    <label for="sales_executive_id" class=" col-md-3"><?php echo app_lang('sales_executive'); ?></label>
                    <div class="col-md-9">
                        <?php
                        echo form_dropdown("sales_executive_id", $sales_executive_dropdown, $model_info->sales_executive_id, "class='select2 sales_executive-select2'");
                        ?>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#invoice-form .sales_executive-select2").select2();
