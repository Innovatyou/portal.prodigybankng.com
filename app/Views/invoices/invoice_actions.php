    ...
    <div class="card-body">
        ...
        <div class="box b-t">
            <div class="box-content pt15 b-r">
                <?php echo anchor(get_uri("invoices/download_pdf/" . $invoice_info->id . "/view"), "<i data-feather='file-text' class='icon-16'></i> " . app_lang('view_pdf'), array("title" => app_lang('view_pdf'), "target" => "_blank", "class" => "d-none d-md-inline-block")); ?>
                <span class="d-block d-md-none"><?php echo js_anchor("<i data-feather='file-text' class='icon-16'></i> " . app_lang('view_pdf'), array('title' => app_lang('view_pdf'), "data-group" => "invoice-pdf", "data-toggle" => "app-modal", "data-sidebar" => "0", "data-url" => get_uri("invoices/view_pdf/" . $invoice_info->id), "class" => "mobile-pdf-view-btn")) ?></span>
            </div>
...
<div class="card">
    <div class="card-body text-center">
        <?php echo modal_anchor(get_uri("invoices/public_pay_url_modal_form"), "<i data-feather='link' class='icon-16'></i> " . app_lang('public_pay_url'), array("class" => "", "title" => app_lang('public_pay_url'), "data-post-invoice_id" => $invoice_info->id)); ?>
    </div>
</div>
