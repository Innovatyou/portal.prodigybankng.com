...
if ($notification->ticket_id && $notification->ticket_title) {
    echo "<div>" . $notification->ticket_display_id . " - " . $notification->ticket_title . "</div>";
}
...
if ($notification->estimate_id) {
    echo "<div>" . $notification->estimate_display_id . "</div>";
}

if ($notification->contract_id && $notification->contract_title) {
    echo "<div>" . $notification->contract_display_id . ": " . $notification->contract_title . "</div>";
}

if ($notification->proposal_id) {
    echo "<div>" . $notification->proposal_display_id . "</div>";
}

if ($notification->order_id) {
    echo "<div>" . $notification->order_display_id . "</div>";
}
...
if ($notification->subscription_id) {
    echo "<div>" . $notification->subscription_display_id . "</div>";
}
