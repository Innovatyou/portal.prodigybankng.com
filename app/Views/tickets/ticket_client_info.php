    ...
    <div class="card-body">
                    ...
                    <div class="float-end">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <?php if ($ticket_info->client_id === "0" && $login_user->user_type == "staff") { ?>
                                <li role="presentation"><?php echo modal_anchor(get_uri("tickets/change_email_modal_form/$ticket_info->id"), "<i data-feather='mail' class='icon-16'></i> " . app_lang('change_email_address'), array("title" => app_lang('change_email_address'), "class" => "dropdown-item")); ?></li>
        ...
        <ul class="list-group info-list">
            ...
            <?php if ($ticket_info->company_name && $ticket_info->requested_by && ($ticket_info->company_name != $ticket_info->requested_by)) { ?>
                <li class="list-group-item border-top pt-2 rounded-0">
            ...
            ?>
                <li class="list-group-item">
                    <span><i data-feather="package" class="icon-16 mr5"></i> <?php echo anchor($url, $total_tickets . " " . app_lang("tickets"), array("class" => "dark")); ?></span>
                    <?php
