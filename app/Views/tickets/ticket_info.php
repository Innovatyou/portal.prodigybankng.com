...
<div class="card-body">
    ...
    <ul class="list-group info-list">
        ...
        <?php if ($ticket_info->merged_with_ticket_id) { ?>
            <div class="list-group-item">
                <span title="<?php echo app_lang("moved_to"); ?>"><i data-feather="git-merge" class="icon-16 mr5"></i> <?php echo anchor(get_uri("tickets/view/" . $ticket_info->merged_with_ticket_id), $ticket_info->merged_with_ticket_display_id, array()); ?></span>
            </div>
        <?php } ?>
