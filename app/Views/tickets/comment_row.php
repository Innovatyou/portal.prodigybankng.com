    ...
    <div class="d-flex">
        ...
        <div class="w-100">
            <div>
                ...
                <?php
                $quick_ai_assistant_target = "quick-ai-assistant-content-" . make_random_string(5);
            ...
            <div class="quick-ai-assistant-message" data-quick-ai-assistant-message-type="<?php echo $comment->user_type === "client" ? "user" : "assistant"; ?>" id="<?php echo $quick_ai_assistant_target; ?>">
                <p>
                    <?php
                    $files = array();
                    if ($comment->files) {
