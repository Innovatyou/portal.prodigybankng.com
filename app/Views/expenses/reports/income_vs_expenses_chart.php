...
<div id="page-content" class="page-wrapper clearfix grid-button">
    <div class="card clearfix">
        <ul id="income-vs-expenses-chart-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs bg-white inner scrollable-tabs clearfix" role="tablist">
            <li class="title-tab">
                <h4 class="pl15 pt10 pr15"><?php echo app_lang("income_vs_expenses"); ?></h4>
            </li>
                        ...
                        <div class="income-vs-expenses-chart-button">
                            ...
                            if ($currencies_dropdown) {
                                echo form_input(array(
                                    ...
                                    "class" => "select2 ml15 w200 reload-chart font-normal",
...
<script type="text/javascript">
    ...
    var prepareExpensesChart = function(data) {
        ...
        var currency = $("#currencies-dropdown").val() || "";
    ...
    $(document).ready(function() {
        ...
        var $projectsDropdown = $("#projects-dropdown"),
            $currenciesDropdown = $("#currencies-dropdown"),
            data = {};
        ...
        <?php if ($currencies_dropdown) { ?>
            $currenciesDropdown.select2({
                data: <?php echo $currencies_dropdown; ?>
            });
        <?php } ?>
