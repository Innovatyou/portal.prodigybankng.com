    ...
    <div class="modal-body clearfix">
        <div class="container-fluid">
            ...
            <div class="form-group form-switch">
                <div class="row">
                    <label for="public_holiday" class=" col-md-3 col-xs-5 col-sm-4"><?php echo app_lang('public_holiday'); ?></label>
                    <div class=" col-md-9 col-xs-7 col-sm-8">
                        <?php
                        echo form_checkbox("public_holiday", "1", $model_info->public_holiday ? true : false, "id='public_holiday' class='form-check-input '");
                        ?>
                    </div>
                </div>
            </div>
