...
$settings_menu = array(
    ...
    "ai_assistant" => array(
        array("name" => "chatgpt", "url" => "settings/chatgpt"),
        array("name" => "gemini", "url" => "settings/gemini"),
        array("name" => "ai_agents", "url" => "ai_agents"),
        array("name" => "ai_assistant_general", "url" => "settings/ai_assistant_general"),
    ),
