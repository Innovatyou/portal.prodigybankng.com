        ...
        <div class="col-sm-9 col-lg-10">
            ...
            <div class="card">
                ...
                <div class="card-body post-dropzone">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10 col-xs-4 col-sm-8">
                                ...
                                echo form_checkbox(
                                    ...
                                    "1",
                                    get_setting('visitors_can_see_store_before_login') ? true : false,
                                    "id='visitors_can_see_store_before_login' class='form-check-input'"
                                );
                                ?>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label for="payment_flow" class=" col-md-2"><?php echo app_lang('payment_flow'); ?></label>
                            <div class=" col-md-10">
                                <?php
                                $payment_flow_dropdown = array(
                                    "" => "-",
                                    "order_invoice_payment" => app_lang("order") . " > " . app_lang("invoice") . " > " . app_lang("payment"),
                                    "payment_order_invoice" => app_lang("payment") . " > " . app_lang("order") . " > " . app_lang("invoice"),
                                );
                                echo form_dropdown(
                                    "payment_flow",
                                    $payment_flow_dropdown,
                                    get_setting("payment_flow"),
                                    "class='select2 mini' id='payment-flow'"
                                );
                                ?>
                            </div>
                        </div>
                    ...
                    <div id="order_status_after_payment_area" class="form-group <?php echo get_setting("payment_flow") === "order_invoice_payment" ? "" : "hide" ?>">
                        <div class="row">
                    ...
                    <div id="accept_order_before_login_area" class="form-group <?php echo (get_setting("visitors_can_see_store_before_login") && !get_setting("payment_flow")) ? "" : "hide" ?>">
                        <div class="row">
                            ...
                            <div class="col-md-10 col-xs-4 col-sm-8">
                                ...
                                echo form_checkbox(
                                    ...
                                    "1",
                                    get_setting('accept_order_before_login') ? true : false,
                                    "id='accept_order_before_login' class='form-check-input'"
                                );
                                ?>
                            </div>
                        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var dropzone = attachDropzoneWithForm("#store-settings-form", uploadUrl, validationUrl, {
            maxFiles: 1
        });
        ...
        var toggleOptionsForPaymentFlow = function() {
            if ($paymentFlow.val() === "order_invoice_payment") {

                $accept_order_before_login_area.addClass("hide");
                $order_status_after_payment_area.removeClass("hide");
            } else if ($paymentFlow.val() === "payment_order_invoice") {

                $accept_order_before_login_area.addClass("hide");
                $order_status_after_payment_area.addClass("hide");
            } else {

                $accept_order_before_login_area.removeClass("hide");
                $order_status_after_payment_area.removeClass("hide");
            }
        };

        $paymentFlow.select2().on("change", function() {
            toggleOptionsForPaymentFlow();
        });
