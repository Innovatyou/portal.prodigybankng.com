...
<div class="mb0">
    ...
    <div class="card-body">
        <div class="form-group form-switch">
            <div class="row">
                <label for="show_recent_ticket_comments_at_the_top" class="col-md-4 col-sm-4 col-xs-12"><?php echo app_lang('show_most_recent_ticket_comments_at_the_top'); ?></label>
        ...
        <div class="form-group form-switch">
            <div class="row">
                <label for="project_reference_in_tickets" class="col-md-4 col-sm-4 col-xs-12"><?php echo app_lang('project_reference_in_tickets'); ?></label>
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <?php
        ...
        <div class="form-group">
            <div class="row">
                <label for="ticket_prefix" class="col-md-4 col-sm-4 col-xs-12"><?php echo app_lang('ticket_prefix'); ?></label>
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <?php
        ...
        <div class="form-group">
            <div class="row">
                <label for="auto_close_ticket_after" class="col-md-4 col-sm-4 col-xs-12"><?php echo app_lang('auto_close_ticket_after'); ?> <span class="help" data-bs-toggle="tooltip" title="<?php echo app_lang('cron_job_required'); ?>"><i data-feather='help-circle' class="icon-16"></i></span></label>
                <div class="col-md-4 col-sm-4 col-xs-12">
        ...
        <div class="form-group form-switch">
            <div class="row">
                <label for="auto_reply_to_tickets" class="col-md-4 col-sm-4 col-xs-12"><?php echo app_lang('auto_reply_to_tickets'); ?></label>
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <?php
        ...
        <div class="form-group form-switch">
            <div class="row">
                <label for="enable_embedded_form_to_get_tickets" class="col-md-4 col-sm-4 col-xs-12"><?php echo app_lang('enable_embedded_form_to_get_tickets'); ?></label>
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <?php
        ...
        <div class="form-group form-switch">
            <div class="row">
                <label for="ask_for_confirmation_before_ticket_reply" class="col-md-4"><?php echo app_lang('ask_for_confirmation_before_ticket_reply'); ?></label>
                <div class="col-md-8">
                    <?php
                    echo form_checkbox("ask_for_confirmation_before_ticket_reply", "1", get_setting("ask_for_confirmation_before_ticket_reply") ? true : false, "id='ask_for_confirmation_before_ticket_reply' class='form-check-input ml15'");
                    ?>
                </div>
            </div>
        </div>
