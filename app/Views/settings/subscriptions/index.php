        ...
        <div class="col-sm-9 col-lg-10">
            <div class="card">
                <ul data-bs-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
                    <li class="title-tab">
                        <h4 class="pl15 pt10 pr15"><?php echo app_lang("subscription_settings"); ?></h4>
                    </li>
                    <li><a role="presentation" data-bs-toggle="tab" href="javascript:;" data-bs-target="#subscription-general-settings-tab"> <?php echo app_lang('general'); ?></a></li>
                    <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("reminder_settings/subscription_reminders"); ?>" data-bs-target="#subscription-reminder-settings-tab"><?php echo app_lang('reminders'); ?></a></li>
                </ul>

                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane fade" id="subscription-general-settings-tab">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <div class="row">
                                    <label for="subscription_prefix" class="col-md-4 col-sm-4 col-xs-12"><?php echo app_lang('subscription_prefix'); ?></label>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <label for="initial_number_of_the_subscription" class="col-md-4 col-sm-4 col-xs-12"><?php echo app_lang('initial_number_of_the_subscription'); ?></label>
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        ...
                                        echo form_input(array(
                                            ...
                                            "type" => "number",
                                            "value" => (get_setting("initial_number_of_the_subscription") > ($last_id + 1)) ? get_setting("initial_number_of_the_subscription") : ($last_id + 1),
                                            "class" => "form-control",
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <label for="enable_stripe_subscription" class="col-md-4 col-sm-4 col-xs-12"><?php echo app_lang('enable_stripe_subscription'); ?></label>
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <?php
                                        $disable = "";
                            ...
                            <div id="stripe-subscription-area" class="<?php echo get_setting("enable_stripe_subscription") ? "" : "hide" ?>">
                                <div class="form-group clearfix">
                                    <div class="row">
                                        <label for="tax_mapping" class="col-md-4 col-sm-4 col-xs-12"><?php echo app_lang('tax_mapping'); ?></label>
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <?php
                                ...
                                <div class="form-group clearfix">
                                    ...
                                    <div class="row">
                                        <label for="webhook_listener_link_of_stripe_subscription" class="col-md-4 col-sm-4 col-xs-12"><?php echo app_lang('webhook_listener_link'); ?></label>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="subscription-reminder-settings-tab"></div>
                </div>
            </div>
        </div>
    </div>
