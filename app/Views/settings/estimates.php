                    ...
                    <div role="tabpanel" class="tab-pane fade" id="estimate-settings-tab">
                        <div class="card-body">
                            <div class="form-group">
                                <div class="row">
                                    <label for="estimate_prefix" class="col-md-4 col-sm-4 col-xs-12"><?php echo app_lang('estimate_prefix'); ?></label>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <label for="estimate_color" class="col-md-4 col-sm-4 col-xs-12"><?php echo app_lang('estimate_color'); ?></label>
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <label for="send_estimate_bcc_to" class="col-md-4 col-sm-4 col-xs-12"><?php echo app_lang('send_estimate_bcc_to'); ?></label>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <label for="initial_number_of_the_estimate" class="col-md-4 col-sm-4 col-xs-12"><?php echo app_lang('initial_number_of_the_estimate'); ?></label>
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <label for="estimate_footer" class="col-md-4 col-sm-4 col-xs-12"><?php echo app_lang('estimate_footer') ?></label>
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <?php
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <label for="create_new_projects_automatically_when_estimates_gets_accepted" class="col-md-4 col-sm-4 col-xs-12"><?php echo app_lang("create_new_projects_automatically_when_estimates_gets_accepted"); ?></label>
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <?php
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <label for="enable_comments_on_estimates" class="col-md-4 col-sm-4 col-xs-12"><?php echo app_lang('enable_comments_on_estimates'); ?></label>
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <?php
                            ...
                            <div id="most_recent_estimate_comments_checkbox_area" class="form-group <?php echo get_setting("enable_comments_on_estimates") ? "" : "hide" ?>">
                                <div class="row">
                                    <label for="show_most_recent_estimate_comments_at_the_top" class="col-md-4 col-sm-4 col-xs-12"><?php echo app_lang('show_most_recent_estimate_comments_at_the_top'); ?></label>
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <?php
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <label for="add_signature_option_on_accepting_estimate" class="col-md-4 col-sm-4 col-xs-12"><?php echo app_lang("add_signature_option_on_accepting_estimate"); ?></label>
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <?php
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <label for="enable_estimate_lock_state" class="col-md-4 col-sm-4 col-xs-12"><?php echo app_lang('enable_lock_state'); ?> <span class="help" data-bs-toggle="tooltip" title="<?php echo app_lang('estimate_lock_state_description'); ?>"><i data-feather='help-circle' class="icon-16"></i></span></label>
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <?php
                                        echo form_checkbox("enable_estimate_lock_state", "1", get_setting("enable_estimate_lock_state") ? true : false, "id='enable_estimate_lock_state' class='form-check-input'");
                                        ?>
                                    </div>
                                </div>
                            </div>
