                    ...
                    <div role="tabpanel" class="tab-pane fade" id="order-settings-tab">
                        <div class="card-body">
                            <div class="form-group">
                                <div class="row">
                                    <label for="order_prefix" class="col-md-4 col-sm-4 col-xs-12"><?php echo app_lang('order_prefix'); ?></label>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <label for="order_color" class="col-md-4 col-sm-4 col-xs-12"><?php echo app_lang('order_color'); ?></label>
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <label for="initial_number_of_the_order" class="col-md-4 col-sm-4 col-xs-12"><?php echo app_lang('initial_number_of_the_order'); ?></label>
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <label for="order_tax" class="col-md-4 col-sm-4 col-xs-12"><?php echo app_lang('tax'); ?></label>
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <?php
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <label for="order_tax" class="col-md-4 col-sm-4 col-xs-12"><?php echo app_lang('second_tax'); ?></label>
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <?php
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <label for="order_footer" class="col-md-4 col-sm-4 col-xs-12"><?php echo app_lang('order_footer') ?></label>
