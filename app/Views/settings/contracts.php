                        ...
                        <div class="card border-top-0 rounded-top-0 clearfix mb0">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <div class="row">
                                        <label for="contract_prefix" class="col-md-4 col-sm-4 col-xs-12"><?php echo app_lang('contract_prefix'); ?></label>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <label for="contract_color" class="col-md-4 col-sm-4 col-xs-12"><?php echo app_lang('contract_color'); ?></label>
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <label for="send_contract_bcc_to" class="col-md-4 col-sm-4 col-xs-12"><?php echo app_lang('send_contract_bcc_to'); ?></label>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <label for="initial_number_of_the_contract" class="col-md-4 col-sm-4 col-xs-12"><?php echo app_lang('initial_number_of_the_contract'); ?></label>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <label for="default_contract_template" class="col-md-4 col-sm-4 col-xs-12"><?php echo app_lang('default_contract_template'); ?></label>
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                ...
                                <div class="form-group form-switch">
                                    <div class="row">
                                        <label for="add_signature_option_on_accepting_contract" class="col-md-4 col-sm-4 col-xs-12"><?php echo app_lang("add_signature_option_on_accepting_contract"); ?></label>
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                ...
                                <div class="form-group form-switch">
                                    <div class="row">
                                        <label for="add_signature_option_for_team_members" class="col-md-4 col-sm-4 col-xs-12"><?php echo app_lang("add_signature_option_for_team_members"); ?></label>
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                ...
                                <div class="form-group form-switch">
                                    <div class="row">
                                        <label for="enable_contract_lock_state" class="col-md-4 col-sm-4 col-xs-12"><?php echo app_lang('enable_lock_state'); ?> <span class="help" data-bs-toggle="tooltip" title="<?php echo app_lang('contract_lock_state_description'); ?>"><i data-feather='help-circle' class="icon-16"></i></span></label>
                                        <div class="col-md-4 col-sm-4 col-xs-12">

                                            <?php
                                            echo form_checkbox("enable_contract_lock_state", "1", get_setting("enable_contract_lock_state") ? true : false, "id='enable_contract_lock_state' class='form-check-input'");
                                            ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group form-switch">
                                    <div class="row">
                                        <label for="disable_contract_pdf_for_clients" class="col-md-4 col-sm-4 col-xs-12"><?php echo app_lang("disable_pdf_for_clients"); ?></label>
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <?php
                                            echo form_checkbox("disable_contract_pdf_for_clients", "1", get_setting("disable_contract_pdf_for_clients") ? true : false, "id='disable_contract_pdf_for_clients' class='form-check-input'");
                                            ?>
                                ...
                                <div class="form-group form-switch">
                                    <div class="row">
                                        <label for="show_item_image_in_contract_item_list" class="col-md-4 col-sm-4 col-xs-12"><?php echo app_lang("show_item_image_in_contract_item_list"); ?></label>
                                        <div class="col-md-8 col-xs-4 col-sm-8">
                                            <?php
                                            echo form_checkbox("show_item_image_in_contract_item_list", "1", get_setting("show_item_image_in_contract_item_list") ? true : false, "id='show_item_image_in_contract_item_list' class='form-check-input'");
                                            ?>
                                        </div>
                                    </div>
                                </div>
