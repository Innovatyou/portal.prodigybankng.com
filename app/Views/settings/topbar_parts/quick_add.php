...
//add project time
if ($login_user->user_type == "staff" && (get_setting("module_project_timesheet") == "1" || get_setting("module_ticket_timesheet") == "1" || get_setting("module_general_task_timesheet") == "1")) {
    $links .= modal_anchor(get_uri("timesheets/modal_form"), app_lang('log_time'), array("class" => "dropdown-item clearfix", "title" => app_lang('log_time'), "id" => "js-quick-add-project-time"));
}
