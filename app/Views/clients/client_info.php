    ...
    <div class="card-body">
        <ul class="list-group info-list pt0 border-top-0">
            ...
            <?php if($client_info->created_date){ ?>
                <li class="list-group-item">
                    <span class="mr10" title="<?php echo app_lang("created_date"); ?>"><i data-feather="calendar" class="icon-16"></i></span>
                    <label><?php echo format_to_relative_time($client_info->created_date); ?></label>
                </li>
            <?php } ?>
