            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <?php if ($model_info->ticket_id && $model_info->project_id) { ?>
                        <div class="col-md-12 mb15">
                            <strong><?php echo app_lang("ticket") . ": "; ?> </strong> <?php echo anchor(get_uri("tickets/view/" . $model_info->ticket_id), $model_info->ticket_display_id . " - " . $model_info->ticket_title); ?>
                        </div>
                    <?php } ?>
                    ...
                    <div class="col-md-12 mb15">
                        <?php
                        if ($model_info->context == "project" && $show_project_timer || $model_info->context != "project" && $show_general_task_timer) {
                            echo view("tasks/task_timer");
                        }
                        ?>
                    </div>

                    <?php if ($model_info->context == "project" && $show_project_timer || $model_info->context != "project" && $show_general_task_timer) { ?>
                        <div class="col-md-12 mb15">
                            <strong><?php echo app_lang("total_time_logged") . ": "; ?></strong>
                            <?php
                            echo ajax_anchor(get_uri("timesheets/task_timesheet/" . $model_info->id . "/" . $model_info->project_id), $total_task_hours, array("data-real-target" => "#task-timesheet", "class" => "strong"));
                            ?>
                        </div>
                        <div class="col-md-12 mb15">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <?php if ($model_info->estimate_id) { ?>
                        <div class="col-md-12 mb15">
                            <strong><?php echo app_lang('estimate') . ": "; ?> </strong> <?php echo anchor(get_uri("estimates/view/" . $model_info->estimate_id), $model_info->estimate_display_id); ?>
                        </div>
                    <?php } ?>

                    <?php if ($model_info->order_id) { ?>
                        <div class="col-md-12 mb15">
                            <strong><?php echo app_lang('order') . ": "; ?> </strong> <?php echo anchor(get_uri("orders/view/" . $model_info->order_id), $model_info->order_display_id); ?>
                        </div>
                    <?php } ?>
                    ...
                    <?php if ($model_info->proposal_id) { ?>
                        <div class="col-md-12 mb15">
                            <strong><?php echo app_lang('proposal') . ": "; ?> </strong> <?php echo anchor(get_uri("proposals/view/" . $model_info->proposal_id), $model_info->proposal_display_id); ?>
                        </div>
                    <?php } ?>
