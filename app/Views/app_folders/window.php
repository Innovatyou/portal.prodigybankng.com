                        ...
                        <div class="d-flex">
                            <div class="flex-shrink-0 me-3 icon-wrapper">
                                ...
                                if (in_array($file_ext, ["jpg", "jpeg", "png"])) {
                                    $file_path = isset($folder_item->thumbnail_file_path) ? $folder_item->thumbnail_file_path : "";
                                    $thumbnail = get_file_thumbnail_preview($folder_item, $file_path, true);
                                }
                                ?>

                                <?php if ($thumbnail) { ?>
                                    <img src="<?php echo $thumbnail; ?>" class="file-thumb">
                                <?php } else {
                                    echo get_file_icon($file_ext, false);
                                } ?>
