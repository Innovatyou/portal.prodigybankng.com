        ...
        <div class="box-content" id="file-manager-items-box">
            <div class="card grid-button" id="file-manager-container-card">
                ...
                <div class="card-body box file-manager-container" id="file-manager-container">
                    ...
                    <?php echo view('app_folders/window', array("controller_slag" => $controller_slag)); ?>
        ...
        if (type === "folder-context-menu" || type === "file-context-menu") {
            ...
            if (type === "folder-context-menu") {
                ...
                if (hasThisFolderWritePermission) {
                    ...
                    var deleteMenu = '<?php echo js_anchor('<i data-feather="trash" class="icon-16 mr10"></i>' . app_lang('delete'), array('title' => app_lang('delete'), 'class' => 'dropdown-item item-delete-button', 'data-id' => '', 'data-action-url' => get_uri($controller_slag . '/delete_folder'), 'data-action' => 'delete-confirmation', 'data-reload-on-success' => true)); ?>';
            ...
            setTimeout(function() {
                if (!window.clickedOnFolderItem) {
                    ...
                    if (hasWritePermission || hasUploadPermission) {
                        $('#folder-context-menu').html('').append($(addNewFolderMenu).attr('data-post-parent_id', parentId).attr('data-post-context_id', contextId).attr('data-post-context', context)).append($(uploadFilesMenu).attr('class', 'dropdown-item').attr('data-post-folder_id', parentId).attr('data-post-client_id', clientId));
                    } else {
...
<?php echo view('app_folders/file_manager_keyboard_helper_js'); ?>