<div class="details-view-top-button clearfix">
    <?php
    echo view("includes/back_button", array("button_url" => get_uri("subscriptions/index"), "button_text" => app_lang("subscriptions"), "extra_class" => "float-start dark"));
    ?>
</div>

<div class="page-content subscription-details-view xs-full-width clearfix">
    ...
    $(document).ready(function() {
        ...
        appContentBuilder.init("<?php echo get_uri('subscriptions/view/' . $subscription_info->id); ?>", {
            ...
            reloadHooks: [{
                ...
                tableId: "subscription-item-table"
            }],
            reload: function(bind, result) {
                bind("#subscription-details-top-bar", result.top_bar);
                bind("#subscription-total-section", result.subscription_total_section);
            }
        });
