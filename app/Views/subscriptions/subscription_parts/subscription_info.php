<div class="mb15"><span class="subscription-info-title" style="font-size:20px; font-weight: bold;background-color: <?php echo $color; ?>; color: #fff;">&nbsp;<?php echo $subscription_info->display_id; ?>&nbsp;</span></div>
