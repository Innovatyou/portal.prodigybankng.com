        ...
        <div class="collapse navbar-collapse">
            <ul class="navbar-nav me-auto mb-lg-0">
                ...
                if (has_my_open_timers()) {
                    echo view("timesheets/open_timers_topbar_icon");
                }
            ...
            <div class="d-flex w-auto">
                <ul class="navbar-nav">
                    ...
                    <?php if (
                        get_setting("ai_chatbox_agents") && $login_user->user_type === "staff"
                        && ($login_user->is_admin || get_array_value($login_user->permissions, "can_access_ai_chatbox"))
                    ) {
                        echo view("settings/topbar_parts/ai_assistant");
                    } ?>
