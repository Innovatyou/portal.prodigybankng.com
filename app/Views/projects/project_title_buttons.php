...
<?php } ?>
<?php
if ($show_project_timer) {
    echo view("timesheets/timer_button", array("context" => "project", "context_id" => $project_info->id, "timer_status" => $timer_status, "disable_timer" => $disable_timer));
}
?>