...
<div id="page-content" class="page-wrapper clearfix">
    ...
    <ul id="team-member-view-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs scrollable-tabs rounded-0 border-top-0" role="tablist">
        ...
        <?php if ($show_timesheets) { ?>
            <li><a role="presentation" data-bs-toggle="tab" href="<?php echo_uri("timesheets/index/" . $user_info->id); ?>" data-bs-target="#tab-timesheets"> <?php echo app_lang('timesheets'); ?></a></li>
        <?php } ?>
