    ...
    private function _make_row($data, $view_type = "") {
        if ($view_type === "modal") {
            ...
            if (get_setting("default_contract_template") !== $data->id) {
                $delete = js_anchor("<i data-feather='x' class='icon-16'></i>", array('title' => app_lang('delete_contract_template'), "class" => "delete me-0", "data-id" => $data->id, "data-action-url" => get_uri("contract_templates/delete"), "data-action" => "delete"));
            }

            return array(
                "<a href='#' data-id='$data->id' class='contract_template-row link'>" . $data->title . "</a>",
                "<a class='edit ms-0'><i data-feather='code' class='icon-16'></i></a>" . modal_anchor(get_uri("contract_templates/modal_form"), "<i data-feather='edit' class='icon-16'></i>", array("class" => "", "title" => app_lang('edit_contract_template'), "data-post-id" => $data->id))
                    . $delete
            );
        }
    }
