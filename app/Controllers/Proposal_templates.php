    ...
    private function _make_row($data, $view_type = "") {
        if ($view_type === "modal") {
            ...
            if (get_setting("default_proposal_template") !== $data->id) {
                $delete = js_anchor("<i data-feather='x' class='icon-16'></i>", array('title' => app_lang('delete_proposal_template'), "class" => "delete me-0", "data-id" => $data->id, "data-action-url" => get_uri("proposal_templates/delete"), "data-action" => "delete"));
            }

            return array("<a href='#' data-id='$data->id' class='proposal_template-row link'>" . $data->title . "</a>",
                "<a class='edit ms-0'><i data-feather='code' class='icon-16'></i></a>" . modal_anchor(get_uri("proposal_templates/modal_form"), "<i data-feather='edit' class='icon-16'></i>", array("class" => "", "title" => app_lang('edit_proposal_template'), "data-post-id" => $data->id))
                . $delete
            );
        }
    }
