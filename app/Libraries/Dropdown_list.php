...
class Dropdown_list {
    ...
    public function prepare_ai_services_dropdown() {
        $ai_services_dropdown = array();

        if (get_setting('enable_chatgpt') && get_setting('chatgpt_authorized')) {
            $ai_services_dropdown[] = array("id" => "chatgpt", "text" => "ChatGPT");
        }

        if (get_setting('enable_gemini') && get_setting('gemini_authorized')) {
            $ai_services_dropdown[] = array("id" => "gemini", "text" =>"Gemini");
        }

        // add hooks here

        return json_encode($ai_services_dropdown);
    }
}
