...
class Pusher_connect {
    ...
    public function trigger_beams_event($beams_interests, $notification_data) {
        ...
        $notification_title = get_array_value($notification_data, "title");
        $notification_message = get_array_value($notification_data, "message");
        $notification_icon = get_array_value($notification_data, "icon");
