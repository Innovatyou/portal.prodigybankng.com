...
$lang["enable_chatgpt"] = "Ενεργοποίηση ChatGPT";
$lang["get_your_api_key_from_here"] = "Αποκτήστε το κλειδί API σας από εδώ:";
$lang["api_key"] = "Κλειδί API";
$lang["model"] = "Μοντέλο";
$lang["chatgpt_error_credentials_message"] = "Το κλειδί API ChatGPT δεν είναι έγκυρο.";

$lang["custom_prompt"] = "Προσαρμοσμένη προτροπή";
$lang["enter_prompt_here"] = "Εισαγάγετε εδώ την προτροπή...";

$lang["ai_summarize"] = "Συνοψίζω";
$lang["ai_improve"] = "Βελτιώ";
$lang["ai_improve_selection"] = "Βελτίωση επιλογής";
$lang["ai_describe"] = "Περιγράφω";
$lang["ai_key_points"] = "Βασικά σημεία";

$lang["import_training_data"] = "Εισαγωγή δεδομένων εκπαίδευσης";
$lang["prompt"] = "Ταχύς";
$lang["response"] = "Απάντηση";
$lang["base_model"] = "Βασικό μοντέλο";
$lang["max_output_tokens_placeholder"] = "Εισαγάγετε τον μέγιστο αριθμό διακριτικών εξόδου. Κρατήστε το κενό για το άπειρο.";
$lang["max_output_tokens"] = "Μέγιστος αριθμός διακριτικών εξόδου";
$lang["training_failed_message"] = "Η εκπαίδευση απέτυχε!";
$lang["training_file"] = "Αρχείο εκπαίδευσης";
$lang["import_knowledge_base_data"] = "Εισαγωγή δεδομένων γνωσιακής βάσης";
$lang["system_prompt"] = "Προτροπή συστήματος";
$lang["import"] = "Εισαγωγή";
$lang["import_excel_data"] = "Εισαγωγή δεδομένων excel";
$lang["sources"] = "Πηγές";
$lang["add_ai_agent"] = "Προσθήκη πράκτορα τεχνητής νοημοσύνης";
$lang["ai_agents"] = "Πράκτορες Τεχνητής Νοημοσύνης";
$lang["ai_agent"] = "Πράκτορας Τεχνητής Νοημοσύνης";
$lang["train_agent"] = "πράκτορας τρένων";
$lang["edit_agent"] = "Επεξεργασία πράκτορα";
$lang["import_text"] = "Εισαγωγή κειμένου";
$lang["text_snippet"] = "Απόσπασμα κειμένου";
$lang["start_training"] = "Έναρξη εκπαίδευσης";
$lang["data_trained"] = "Εκπαιδευμένα δεδομένα";
$lang["of"] = "του";
$lang["import_knowledge_base_articles"] = "Εισαγωγή άρθρων γνωσιακής βάσης";
$lang["import_from_excel_file"] = "Εισαγωγή από αρχείο excel";
$lang["import_from_txt_file"] = "Εισαγωγή από αρχείο txt";
$lang["input_text_prompt"] = "Προτροπή εισαγωγής κειμένου";
$lang["no_training_data_messgae"] = "Δεν έχετε προσθέσει ακόμη δεδομένα εκπαίδευσης.<br /> Παρακαλώ προσθέστε πρώτα τα δεδομένα εκπαίδευσής σας!";
$lang["temperature"] = "Θερμοκρασία";
$lang["temperature_help_message"] = "Η ρύθμιση χαμηλότερης θερμοκρασίας (π.χ., 0,2) έχει ως αποτέλεσμα πιο συνεπή και προβλέψιμα αποτελέσματα, ενώ μια υψηλότερη θερμοκρασία (π.χ., 1,0) οδηγεί σε πιο ποικίλες και δημιουργικές αποκρίσεις. Επιλέξτε τη θερμοκρασία με βάση την ανάγκη σας για αξιοπιστία έναντι της πρωτοτυπίας. Η τιμή μπορεί να κυμαίνεται μεταξύ 0 και 1.";
$lang["chatgpt_not_authorized_message"] = "Το ChatGPT δεν είναι εξουσιοδοτημένο. Παρακαλούμε πρώτα να εξουσιοδοτήσετε το ChatGPT.";
$lang["import_from_existing_agent"] = "Εισαγωγή από υπάρχοντα αντιπρόσωπο";
$lang["kb_articles_source_exists_error_message_for_agent_importing"] = "Ο τρέχων εκπρόσωπος έχει ήδη μια πηγή άρθρων γνωσιακής βάσης. Για να εισαγάγετε αυτόν τον εκπρόσωπο, διαγράψτε την υπάρχουσα πηγή άρθρων γνωσιακής βάσης από τον τρέχοντα εκπρόσωπο!";
$lang["kb_articles_source_exists_error_message"] = "Αυτός ο εκπρόσωπος έχει ήδη μια πηγή άρθρων γνωσιακής βάσης. Διαγράψτε πρώτα την υπάρχουσα πηγή άρθρων γνωσιακής βάσης για να την εισαγάγετε ξανά!";
$lang["data_total"] = "Σύνολο δεδομένων";
$lang["pending_deletion"] = "Εκκρεμεί διαγραφή";
$lang["agent_type"] = "Τύπος πράκτορα";
$lang["app_action"] = "Ενέργεια εφαρμογής";
$lang["assistant"] = "Βοηθός";
$lang["model_type"] = "Τύπος μοντέλου";
$lang["text"] = "Κείμενο";
$lang["image"] = "Εικών";
$lang["parameters"] = "Παράμετροι";
$lang["all_agents"] = "Όλοι οι πράκτορες";
$lang["specific_agents"] = "Συγκεκριμένοι παράγοντες";
$lang["choose_agents"] = "Επιλέξτε πράκτορες";
$lang["app_actions"] = "Ενέργειες εφαρμογής";
$lang["ai_assistant"] = "Βοηθός Τεχνητής Νοημοσύνης";
$lang["chatgpt"] = "ChatGPT";
$lang["write_with"] = "Γράψτε με";
$lang["ai_assistant_general"] = "Γενικές ρυθμίσεις";
$lang["no_ai_integration_error_message"] = "Δεν έχετε ενεργή ενσωμάτωση τεχνητής νοημοσύνης. Ενεργοποιήστε πρώτα το ChatGPT ή το Gemini.";
$lang["quick_assistant"] = "Γρήγορος βοηθός";
$lang["quick_assistant_instructions"] = "Ενεργοποιεί εργαλεία επεξεργασίας κειμένου με τεχνητή νοημοσύνη σε όλη την εφαρμογή, συμπεριλαμβανομένων λειτουργιών όπως σύνοψη, περιγραφή, βελτίωση και προσαρμοσμένες προτροπές.";
$lang["ticket_assistant"] = "Βοηθός εισιτηρίων";
$lang["ticket_assistant_instructions"] = "Προσθέτει τη δυνατότητα δημιουργίας απαντήσεων με τη βοήθεια τεχνητής νοημοσύνης στο σύστημα αιτημάτων.";
$lang["ai_chatbox"] = "Κουτί συνομιλίας τεχνητής νοημοσύνης";
$lang["ai_chatbox_instructions"] = "Παρέχει πρόσβαση στον βοηθό τεχνητής νοημοσύνης μέσω μιας μόνιμης διεπαφής συνομιλίας. Μπορείτε να αποκτήσετε πρόσβαση σε αυτόν από την επάνω γραμμή πλοήγησης.";
$lang["quick_assistant_settings"] = "Ρυθμίσεις γρήγορου βοηθού";
$lang["ticket_assistant_settings"] = "Ρυθμίσεις βοηθού έκδοσης εισιτηρίων";
$lang["ai_chatbox_settings"] = "Ρυθμίσεις συνομιλίας τεχνητής νοημοσύνης";
$lang["can_access_quick_assistant"] = "Μπορώ να έχω πρόσβαση στον γρήγορο βοηθό;";
$lang["set_ai_assistant_permissions"] = "Ορισμός δικαιωμάτων βοηθού AI";
$lang["can_access_ai_chatbox"] = "Μπορώ να έχω πρόσβαση στο chatbox της τεχνητής νοημοσύνης;";
$lang["accessible_ai_agents"] = "Προσβάσιμοι πράκτορες τεχνητής νοημοσύνης";

$lang["gemini"] = "Gemini";
$lang["enable_gemini"] = "Ενεργοποίηση Διδύμων";
$lang["gemini_api_key"] = "Κλειδί API Gemini";
$lang["enter_your_gemini_api_key"] = "Εισαγάγετε το κλειδί API Gemini σας";
$lang["gemini_error_credentials_message"] = "Αποτυχία ελέγχου ταυτότητας με το Gemini. Ελέγξτε το κλειδί API σας.";
$lang["ai_service"] = "Υπηρεσία Τεχνητής Νοημοσύνης";
$lang["tts"] = "TTS (Μετατροπή κειμένου σε ομιλία)";
$lang["video"] = "Βίντεο";

$lang["change_email_address"] = "Αλλαγή διεύθυνσης ηλεκτρονικού ταχυδρομείου";
$lang["sales_executive"] = "Στέλεχος Πωλήσεων";
...
$lang["import_max_row_limit_exceeded"] = "Το μεταφορτωμένο αρχείο υπερβαίνει τον μέγιστο επιτρεπόμενο αριθμό γραμμών. Ο μέγιστος επιτρεπόμενος αριθμός γραμμών είναι %s.";

$lang["image"] = "Εικών";
$lang["show_item_image_in_contract_item_list"] = "Εμφάνιση εικόνας αντικειμένου στη λίστα αντικειμένων σύμβασης";
$lang["show_item_image_in_proposal_item_list"] = "Εμφάνιση εικόνας αντικειμένου στη λίστα προτεινόμενων στοιχείων";
$lang["payment_flow"] = "Ροή πληρωμών";
$lang["process_your_payment_to_place_the_order"] = "Επεξεργαστείτε την πληρωμή σας για να υποβάλετε την παραγγελία.";
$lang["process_payment"] = "Επεξεργασία πληρωμής";

$lang["confirm_and_proceed_to_payment"] = "Επιβεβαίωση και συνέχιση πληρωμής";

$lang["contracts_expiring_soon"] = "Συμβάσεις που λήγουν σύντομα";
$lang["ask_for_confirmation_before_ticket_reply"] = "Ζητήστε επιβεβαίωση πριν από την απάντηση του αιτήματος";
$lang["send_ticket_reply_confirmation_message"] = "Είστε σίγουροι; Θα στείλετε αυτήν την απάντηση στον πελάτη σας.";

$lang["public_holiday"] = "Δημόσια αργία";

$lang["client_can_access_knowledge_base_only_after_login"] = "Ο πελάτης μπορεί να έχει πρόσβαση στη βάση γνώσεων μόνο μετά την είσοδό του";
$lang["knowledge_base_login_required_help_text"] = "Η βάση γνώσεων είναι δημόσια προσβάσιμη, εκτός εάν ενεργοποιήσετε αυτήν την επιλογή.";

$lang["import_max_row_limit_exceeded"] = "Το μεταφορτωμένο αρχείο υπερβαίνει τον μέγιστο επιτρεπόμενο αριθμό γραμμών. Ο μέγιστος επιτρεπόμενος αριθμός γραμμών είναι %s.";

$lang["recent_chats"] = "Πρόσφατες συνομιλίες";
$lang["no_ai_agents_found"] = "Δεν βρέθηκαν πράκτορες τεχνητής νοημοσύνης";
$lang["ask_anything"] = "Ρώτα οτιδήποτε";
$lang["thinking"] = "Σκέψη";
$lang["ai_agent_permission_error_message"] = "Δεν έχετε πρόσβαση σε αυτόν τον πράκτορα Τεχνητής Νοημοσύνης.";
$lang["mark_as_active"] = "Επισήμανση ως ενεργή";
$lang["agent_status_updated"] = "Η κατάσταση του πράκτορα ενημερώθηκε!";

$lang["initial_ai_chat_message"] = "Hi! <br /> How can I help you?";

$lang["contact_type"] = "Τύπος επαφής";
$lang["select_existing"] = "Επιλογή υπάρχουσας";
$lang["use_existing_password"] = "Χρήση υπάρχοντος κωδικού πρόσβασης";
$lang["reject_reason"] = "Αιτιολογία απόρριψης";
$lang["rejection_reason"] = "Λόγος απόρριψης";

$lang["order_id"] = "Αναγνωριστικό παραγγελίας";
$lang["estimate_id"] = "Αναγνωριστικό εκτίμησης";
$lang["proposal_id"] = "Αναγνωριστικό πρότασης";
$lang["contract_id"] = "Αναγνωριστικό σύμβασης";

$lang["about"] = "Για";
$lang["contact_us"] = "Επικοινωνήστε μαζί μας";
$lang["links"] = "Εδαφος διά παιγνίδι γκολφ";

$lang["import_max_row_limit_exceeded"] = "Το μεταφορτωμένο αρχείο υπερβαίνει τον μέγιστο επιτρεπόμενο αριθμό γραμμών. Ο μέγιστος επιτρεπόμενος αριθμός γραμμών είναι %s.";
$lang["access_denied"] = "Δεν επιτρέπεται η πρόσβαση!";

$lang["social_link"] = "Κοινωνικός σύνδεσμος";
$lang["edit_footer_social_link"] = "Επεξεργασία συνδέσμου κοινωνικής δικτύωσης υποσέλιδου";
$lang["brand_profile"] = "Προφίλ μάρκας";
$lang["custom_column"] = "Προσαρμοσμένη στήλη";
$lang["link"] = "Σύνδεσμος";
$lang["quick_links"] = "Γρήγοροι σύνδεσμοι";
$lang["quick_link_name"] = "Όνομα γρήγορου συνδέσμου";
$lang["edit_footer_quick_link"] = "Επεξεργασία γρήγορου συνδέσμου υποσέλιδου";
$lang["upload_icon"] = "Εικονίδιο μεταφόρτωσης";
$lang["link_title"] = "Τίτλος συνδέσμου";
