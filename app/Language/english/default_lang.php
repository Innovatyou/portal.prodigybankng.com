...
$lang["enable_chatgpt"] = "Enable ChatGPT";
$lang["get_your_api_key_from_here"] = "Get your API key from here:";
$lang["api_key"] = "API Key";
$lang["model"] = "Model";
$lang["chatgpt_error_credentials_message"] = "ChatGPT API key is invalid.";

$lang["custom_prompt"] = "Custom prompt";
$lang["enter_prompt_here"] = "Enter prompt here...";

$lang["ai_summarize"] = "Summarize";
$lang["ai_improve"] = "Improve";
$lang["ai_improve_selection"] = "Improve selection";
$lang["ai_describe"] = "Describe";
$lang["ai_key_points"] = "Key points";

$lang["import_training_data"] = "Import training data";
$lang["prompt"] = "Prompt";
$lang["response"] = "Response";
$lang["base_model"] = "Base model";
$lang["max_output_tokens_placeholder"] = "Enter max output tokens. Keep it blank for infinity.";
$lang["max_output_tokens"] = "Max output tokens";
$lang["training_failed_message"] = "Training failed!";
$lang["training_file"] = "Training file";
$lang["import_knowledge_base_data"] = "Import knowledge base data";
$lang["system_prompt"] = "System prompt";
$lang["import"] = "Import";
$lang["import_excel_data"] = "Import excel data";
$lang["sources"] = "Sources";
$lang["add_ai_agent"] = "Add AI agent";
$lang["ai_agents"] = "AI agents";
$lang["ai_agent"] = "AI agent";
$lang["train_agent"] = "Train agent";
$lang["edit_agent"] = "Edit agent";
$lang["import_text"] = "Import text";
$lang["text_snippet"] = "Text snippet";
$lang["start_training"] = "Start training";
$lang["data_trained"] = "Data trained";
$lang["of"] = "of";
$lang["import_knowledge_base_articles"] = "Import knowledge base articles";
$lang["import_from_excel_file"] = "Import from excel file";
$lang["import_from_txt_file"] = "Import from txt file";
$lang["input_text_prompt"] = "Input text prompt";
$lang["no_training_data_messgae"] = "You haven't added any training data yet. <br /> Please add your training data first!";
$lang["temperature"] = "Temperature";
$lang["temperature_help_message"] = "Setting a lower temperature (e.g., 0.2) results in more consistent and predictable outputs, while a higher temperature (e.g., 1.0) leads to more diverse and creative responses. Choose the temperature based on your need for reliability versus originality. The value can range between 0 and 1.";
$lang["chatgpt_not_authorized_message"] = "ChatGPT is not authorized. Please authorize ChatGPT first.";
$lang["import_from_existing_agent"] = "Import from existing agent";
$lang["kb_articles_source_exists_error_message_for_agent_importing"] = "Current agent already has a source of knowledge base articles. To import this agent, please delete the existing source of knowledge base articles from current agent!";
$lang["kb_articles_source_exists_error_message"] = "This agent already has a source of knowledge base articles. Please delete the existing source of knowledge base articles first to import again!";
$lang["data_total"] = "Data total";
$lang["pending_deletion"] = "Pending deletion";
$lang["agent_type"] = "Agent type";
$lang["app_action"] = "App action";
$lang["assistant"] = "Assistant";
$lang["model_type"] = "Model type";
$lang["text"] = "Text";
$lang["image"] = "Image";
$lang["parameters"] = "Parameters";
$lang["all_agents"] = "All agents";
$lang["specific_agents"] = "Specific agents";
$lang["choose_agents"] = "Choose agents";
$lang["app_actions"] = "App actions";
$lang["ai_assistant"] = "AI Assistant";
$lang["chatgpt"] = "ChatGPT";
$lang["write_with"] = "Write with";
$lang["ai_assistant_general"] = "General settings";
$lang["no_ai_integration_error_message"] = "You don't have any active AI Integration. Please enable ChatGPT or Gemini first.";
$lang["quick_assistant"] = "Quick assistant";
$lang["quick_assistant_instructions"] = "Enables AI-powered text processing tools throughout the application, including features like summarization, description, improving, and custom prompts.";
$lang["ticket_assistant"] = "Ticket assistant";
$lang["ticket_assistant_instructions"] = "Adds AI-assisted response generation to the ticket system.";
$lang["ai_chatbox"] = "AI chatbox";
$lang["ai_chatbox_instructions"] = "Provides access to the AI assistant via a persistent chat interface. It can be accessed from the top navigation bar.";
$lang["quick_assistant_settings"] = "Quick assistant settings";
$lang["ticket_assistant_settings"] = "Ticket assistant settings";
$lang["ai_chatbox_settings"] = "AI chatbox settings";
$lang["can_access_quick_assistant"] = "Can access quick assistant?";
$lang["set_ai_assistant_permissions"] = "Set AI assistant permissions";
$lang["can_access_ai_chatbox"] = "Can access AI chatbox?";
$lang["accessible_ai_agents"] = "Accessible AI agents";

$lang["gemini"] = "Gemini";
$lang["enable_gemini"] = "Enable Gemini";
$lang["gemini_api_key"] = "Gemini API Key";
$lang["enter_your_gemini_api_key"] = "Enter your Gemini API key";
$lang["gemini_error_credentials_message"] = "Failed to authenticate with Gemini. Please check your API key.";
$lang["ai_service"] = "AI service";
$lang["tts"] = "TTS (Text-to-Speech)";
$lang["video"] = "Video";

$lang["change_email_address"] = "Change Email Address";
$lang["sales_executive"] = "Sales Executive";
...
$lang["import_max_row_limit_exceeded"] = "The uploaded file exceeds the maximum allowed number of rows. The maximum allowed number of rows is %s.";

$lang["image"] = "Image";
$lang["show_item_image_in_contract_item_list"] = "Show item image in contract item list";
$lang["show_item_image_in_proposal_item_list"] = "Show item image in proposal item list";
$lang["payment_flow"] = "Payment flow";
$lang["process_your_payment_to_place_the_order"] = "Process your payment to place the order.";
$lang["process_payment"] = "Process Payment";

$lang["confirm_and_proceed_to_payment"] = "Confirm & proceed to payment";

$lang["contracts_expiring_soon"] = "Contracts expiring soon";
$lang["ask_for_confirmation_before_ticket_reply"] = "Ask for confirmation before ticket reply";
$lang["send_ticket_reply_confirmation_message"] = "Are you sure? You are going to send this reply to your client.";

$lang["public_holiday"] = "Public holiday";

$lang["client_can_access_knowledge_base_only_after_login"] = "Client can access knowledge base only after login";
$lang["knowledge_base_login_required_help_text"] = "The knowledge base is publicly accessible unless you enable this option.";

$lang["import_max_row_limit_exceeded"] = "The uploaded file exceeds the maximum allowed number of rows. The maximum allowed number of rows is %s.";

$lang["recent_chats"] = "Recent Chats";
$lang["no_ai_agents_found"] = "No AI agents found";
$lang["ask_anything"] = "Ask anything";
$lang["thinking"] = "Thinking";
$lang["ai_agent_permission_error_message"] = "You don't have access on this AI agent.";
$lang["mark_as_active"] = "Mark as active";
$lang["agent_status_updated"] = "Agent status updated!";

$lang["initial_ai_chat_message"] = "Hi! <br /> How can I help you?";

$lang["contact_type"] = "Contact type";
$lang["select_existing"] = "Select existing";
$lang["use_existing_password"] = "Use existing password";
...
$lang["edit_footer_social_link"] = "Edit footer social link";
$lang["brand_profile"] = "Brand Profile";
$lang["custom_column"] = "Custom column";
$lang["link"] = "Link";
$lang["quick_links"] = "Quick Links";
$lang["quick_link_name"] = "Quick Link Name";
$lang["edit_footer_quick_link"] = "Edit footer quick link";
