...
$lang["can_not_access_contracts"] = "Не могу получить доступ к контрактам";
$lang["can_manage_all_contracts"] = "Может управлять всеми контрактами";
$lang["can_manage_only_own_client_contracts"] = "Может управлять только контрактами своих клиентов";
$lang["can_see_only_own_client_contracts"] = "Может видеть только контракты своих клиентов";

$lang["this_action_will_do_the_following"] = "Это действие выполнит следующее:";
$lang["create_new_client"] = "Создать нового клиента";
$lang["create_client_contact"] = "Создать контакт с клиентом";
$lang["add_client_contact"] = "Добавить контакт клиента";
$lang["link_the_client_with_this_ticket"] = "Свяжите клиента с этим тикетом";
$lang["link_client_to_existing_client_suggestion"] = "Клиент с таким адресом электронной почты уже существует. Вместо создания нового клиента вы можете связать его с этим тикетом.";

$lang["client_vat_or_gst_number"] = "Номер НДС/GST";

$lang["ui_options"] = "Параметры пользовательского интерфейса";
$lang["filter_bar"] = "Панель фильтров";
$lang["keep_filter_bar_collapsed"] = "Сохранять панель фильтров свернутой";
...
$lang["enable_chatgpt"] = "Включить ChatGPT";
$lang["get_your_api_key_from_here"] = "Получите свой API-ключ здесь:";
$lang["api_key"] = "Ключ API";
$lang["model"] = "Модель";
$lang["chatgpt_error_credentials_message"] = "Ключ API ChatGPT недействителен.";

$lang["custom_prompt"] = "Пользовательская подсказка";
$lang["enter_prompt_here"] = "Введите запрос здесь...";

$lang["ai_summarize"] = "Подведите итоги";
$lang["ai_improve"] = "Улучшать";
$lang["ai_improve_selection"] = "Улучшить выбор";
$lang["ai_describe"] = "Описывать";
$lang["ai_key_points"] = "Ключевые моменты";

$lang["import_training_data"] = "Импорт обучающих данных";
$lang["prompt"] = "Быстрый";
$lang["response"] = "Ответ";
$lang["base_model"] = "Базовая модель";
$lang["max_output_tokens_placeholder"] = "Введите максимальное количество токенов для вывода. Оставьте поле пустым для бесконечности.";
$lang["max_output_tokens"] = "Максимальное количество выходных токенов";
$lang["training_failed_message"] = "Тренировка провалилась!";
$lang["training_file"] = "Файл обучения";
$lang["import_knowledge_base_data"] = "Импорт данных из базы знаний";
$lang["system_prompt"] = "Системная подсказка";
$lang["import"] = "Импорт";
$lang["import_excel_data"] = "Импорт данных из Excel";
$lang["sources"] = "Источники";
$lang["add_ai_agent"] = "Добавить агента ИИ";
$lang["ai_agents"] = "ИИ-агенты";
$lang["ai_agent"] = "ИИ-агент";
$lang["train_agent"] = "Железнодорожный агент";
$lang["edit_agent"] = "Редактировать агента";
$lang["import_text"] = "Импорт текста";
$lang["text_snippet"] = "Фрагмент текста";
$lang["start_training"] = "Начать обучение";
$lang["data_trained"] = "обученные данные";
$lang["of"] = "из";
$lang["import_knowledge_base_articles"] = "Импорт статей базы знаний";
$lang["import_from_excel_file"] = "Импорт из файла Excel";
$lang["import_from_txt_file"] = "Импорт из текстового файла";
$lang["input_text_prompt"] = "Введите текстовое поле";
$lang["no_training_data_messgae"] = "Вы еще не добавили никаких обучающих данных.<br /> Пожалуйста, сначала добавьте свои обучающие данные!";
$lang["temperature"] = "Температура";
$lang["temperature_help_message"] = "Установка более низкой температуры (например, 0,2) приводит к более стабильным и предсказуемым результатам, в то время как более высокая температура (например, 1,0) ведет к более разнообразным и креативным ответам. Выбирайте температуру в зависимости от того, что для вас важнее: надежность или оригинальность. Значение может варьироваться от 0 до 1.";
$lang["chatgpt_not_authorized_message"] = "ChatGPT не авторизован. Пожалуйста, сначала авторизуйте ChatGPT.";
$lang["import_from_existing_agent"] = "Импорт с существующего агента";
$lang["kb_articles_source_exists_error_message_for_agent_importing"] = "У текущего агента уже есть источник статей базы знаний. Чтобы импортировать этого агента, пожалуйста, удалите существующий источник статей базы знаний у текущего агента!";
$lang["kb_articles_source_exists_error_message"] = "У этого агента уже есть источник статей базы знаний. Пожалуйста, сначала удалите существующий источник статей базы знаний, прежде чем импортировать их снова!";
$lang["data_total"] = "Данные в сумме";
$lang["pending_deletion"] = "Ожидается удаление";
$lang["agent_type"] = "Тип агента";
$lang["app_action"] = "Действие приложения";
$lang["assistant"] = "Помощник";
$lang["model_type"] = "Тип модели";
$lang["text"] = "Текст";
$lang["image"] = "Изображение";
$lang["parameters"] = "Параметры";
$lang["all_agents"] = "Все агенты";
$lang["specific_agents"] = "Конкретные агенты";
$lang["choose_agents"] = "Выберите агентов";
$lang["app_actions"] = "Действия приложения";
$lang["ai_assistant"] = "ИИ-помощник";
$lang["chatgpt"] = "ChatGPT";
$lang["write_with"] = "Пишите с помощью";
$lang["ai_assistant_general"] = "Общие настройки";
$lang["no_ai_integration_error_message"] = "У вас нет активной интеграции с ИИ. Пожалуйста, сначала включите ChatGPT или Gemini.";
$lang["quick_assistant"] = "Быстрый помощник";
$lang["quick_assistant_instructions"] = "Включает в себя инструменты обработки текста на основе искусственного интеллекта, используемые во всем приложении, в том числе такие функции, как суммирование, описание, улучшение и пользовательские подсказки.";
$lang["ticket_assistant"] = "Билетный ассистент";
$lang["ticket_assistant_instructions"] = "Добавляет в систему обработки заявок функцию генерации ответов с помощью ИИ.";
$lang["ai_chatbox"] = "чат с ИИ";
$lang["ai_chatbox_instructions"] = "Предоставляет доступ к ИИ-помощнику через постоянно доступный интерфейс чата. Доступ к нему осуществляется через верхнюю панель навигации.";
$lang["quick_assistant_settings"] = "Настройки быстрого помощника";
$lang["ticket_assistant_settings"] = "Настройки помощника по продаже билетов";
$lang["ai_chatbox_settings"] = "Настройки чата с ИИ";
$lang["can_access_quick_assistant"] = "Можно ли получить доступ к быстрому помощнику?";
$lang["set_ai_assistant_permissions"] = "Настройте права доступа для ИИ-помощника.";
$lang["can_access_ai_chatbox"] = "Можно ли получить доступ к чату с ИИ?";
$lang["accessible_ai_agents"] = "Доступные агенты искусственного интеллекта";

$lang["gemini"] = "Gemini";
$lang["enable_gemini"] = "Включить Gemini";
$lang["gemini_api_key"] = "Ключ API Gemini";
$lang["enter_your_gemini_api_key"] = "Введите свой API-ключ Gemini";
$lang["gemini_error_credentials_message"] = "Не удалось пройти аутентификацию в Gemini. Пожалуйста, проверьте свой API-ключ.";
$lang["ai_service"] = "сервис искусственного интеллекта";
$lang["tts"] = "TTS (преобразование текста в речь)";
$lang["video"] = "Видео";

$lang["change_email_address"] = "Изменить адрес электронной почты";
$lang["sales_executive"] = "Директор по продажам";
...
$lang["import_max_row_limit_exceeded"] = "Загруженный файл превышает максимально допустимое количество строк. Максимально допустимое количество строк составляет %s.";

$lang["image"] = "Изображение";
$lang["show_item_image_in_contract_item_list"] = "Показать изображение позиции в списке позиций контракта";
$lang["show_item_image_in_proposal_item_list"] = "Показать изображение элемента в списке элементов предложения";
$lang["payment_flow"] = "Поток платежей";
$lang["process_your_payment_to_place_the_order"] = "Для оформления заказа произведите оплату.";
$lang["process_payment"] = "Обработка платежа";

$lang["confirm_and_proceed_to_payment"] = "Подтвердите и перейдите к оплате";

$lang["contracts_expiring_soon"] = "Срок действия контрактов скоро истекает";
$lang["ask_for_confirmation_before_ticket_reply"] = "Перед ответом на заявку запросите подтверждение.";
$lang["send_ticket_reply_confirmation_message"] = "Вы уверены? Вы собираетесь отправить этот ответ своему клиенту.";

$lang["public_holiday"] = "Праздник";

$lang["client_can_access_knowledge_base_only_after_login"] = "Клиент может получить доступ к базе знаний только после авторизации.";
$lang["knowledge_base_login_required_help_text"] = "База знаний находится в открытом доступе, если вы не включите эту опцию.";

$lang["import_max_row_limit_exceeded"] = "Загруженный файл превышает максимально допустимое количество строк. Максимально допустимое количество строк составляет %s.";

$lang["recent_chats"] = "Недавние чаты";
$lang["no_ai_agents_found"] = "Агенты ИИ не обнаружены.";
$lang["ask_anything"] = "Спрашивайте что угодно";
$lang["thinking"] = "Мышление";
$lang["ai_agent_permission_error_message"] = "У вас нет доступа к этому агенту ИИ.";
$lang["mark_as_active"] = "Отметить как активный";
$lang["agent_status_updated"] = "Статус агента обновлен!";

$lang["initial_ai_chat_message"] = "Hi! <br /> How can I help you?";

$lang["contact_type"] = "Тип контакта";
$lang["select_existing"] = "Выберите существующий";
$lang["use_existing_password"] = "Используйте существующий пароль";
$lang["reject_reason"] = "Причина отказа";
$lang["rejection_reason"] = "Причина отказа";

$lang["order_id"] = "Идентификатор заказа";
$lang["estimate_id"] = "Оценочный идентификатор";
$lang["proposal_id"] = "Идентификатор предложения";
$lang["contract_id"] = "Идентификатор контракта";
...
$lang["social_link"] = "Социальная ссылка";
$lang["edit_footer_social_link"] = "Редактировать ссылку на социальную сеть в нижнем колонтитуле";
$lang["brand_profile"] = "Профиль бренда";
$lang["custom_column"] = "Пользовательская колонка";
$lang["link"] = "Связь";
$lang["quick_links"] = "Быстрые ссылки";
$lang["quick_link_name"] = "Название быстрой ссылки";
$lang["edit_footer_quick_link"] = "Редактировать колонтитул (быстрая ссылка)";
$lang["upload_icon"] = "Значок загрузки";
