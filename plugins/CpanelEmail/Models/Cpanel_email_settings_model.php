...
namespace CpanelEmail\Models;

use App\Models\Crud_model;

class Cpanel_email_settings_model extends Crud_model {

    protected $table = null;

    function __construct() {
        $this->table = 'cpanel_email_settings';
    ...
    function get_all_settings() {
        $settings_table = $this->db->prefixTable('cpanel_email_settings');
